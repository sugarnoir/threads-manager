 ...
 * app_config のパラメータから動的に生成。
 * フォールバックとして旧ハードコードリストも保持。
 */

import { generateAccountUA } from '../lib/ua-generator'
...
/** app_config のプールから動的にUAを生成する（新規アカウント用） */
export function pickRandomIphoneUA(): string {
  return generateAccountUA()
}
