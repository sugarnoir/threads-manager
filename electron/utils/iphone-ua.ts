/**
 * iPhone User-Agent リスト（モバイル API 投稿用）
 * アカウント作成時にランダムに1つ割り当てて固定する
 */

export const IPHONE_UA_LIST = [
  // iPhone 14 Pro Max (iOS 17.5)
  'Mozilla/5.0 (iPhone; CPU iPhone OS 17_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.5 Mobile/15E148 Safari/604.1',
  // iPhone 15 Pro (iOS 17.4)
  'Mozilla/5.0 (iPhone; CPU iPhone OS 17_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.4 Mobile/15E148 Safari/604.1',
  // iPhone 13 Pro Max (iOS 16.6)
  ...
  // iPhone SE 3rd gen (iOS 16.4)
  'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
]

/** UAリストからランダムに1つ返す */
export function pickRandomIphoneUA(): string {
  return IPHONE_UA_LIST[Math.floor(Math.random() * IPHONE_UA_LIST.length)]
}
