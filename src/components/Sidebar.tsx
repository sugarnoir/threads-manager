...
const BOTTOM_TOOLS: { id: ToolType; label: string; icon: JSX.Element }[] = [
  {
    ...
    label: 'いいね',
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#e00055" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="px-3 pb-3 shrink-0">
        <div className="grid grid-cols-3 gap-1.5">
          {([
            ...
            { id: 'status'   as ToolType, label: 'アカウント\nチェック', Icon: IconCheck },
            ...
            return (
              ...
              >
                <Icon />
                <span className="text-[10px] leading-tight font-medium whitespace-pre-line">{label}</span>
              </button>
            )
          })}
        </div>
